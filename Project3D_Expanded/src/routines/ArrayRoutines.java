...
public class ArrayRoutines 
{
    ...
    */
    ...
    // arr = Destination (Texture) array.
    // elements = Source (Texture) array.
    public static void addAll(Texture[] arr, Texture ... elements)
    {
        
        // The function allows for the addition of one to many Texture values to an array (passed).
        // The three dots can only be used in a method argument, and are called varargs. 
        // The three dots (varargs) allow the passing in of an array of parameters without explicitly 
        // creating the array.
        // The function places the elements at the beginning of the destination array (arr).
        // Usage:  addAll(texSides, new Texture(Gdx.files.internal("assets/xneg.png")), 
    ...
    // destPos = Position at which to copy within the target (arr), base 0.  0 = First array element.
    // elements = Source (Texture) array.
    public static void addAll(Texture[] arr, String destPos, Texture ... elements)
    {
        ...
        // creating the array.
        // The function places the elements at the specified index (destPos) within the destination array (arr).
        // Usage:  addAll(texSides, 1, new Texture(Gdx.files.internal("assets/xneg.png")), 
        // new Texture(Gdx.files.internal("assets/xpos.png")), 
        // new Texture(Gdx.files.internal("assets/yneg.png")));
    ...
    // arr = Destination (Texture) array.
    // elements = Source (Texture) array.
    public static void addAll_End(Texture[] arr, Texture ... elements)
    {
        ...
        // creating the array.
        // The function places the elements at the end of the destination array (arr).
        // Usage:  addAll_End(texSides, new Texture(Gdx.files.internal("assets/xneg.png")), 
        // new Texture(Gdx.files.internal("assets/xpos.png")), 
        // new Texture(Gdx.files.internal("assets/yneg.png")));
