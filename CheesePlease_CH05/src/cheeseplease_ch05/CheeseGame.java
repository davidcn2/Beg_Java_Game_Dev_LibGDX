...
public class CheeseGame extends BaseGame { // Extends the Game class from LibGDX.
            ...
            
    {
        ...
        ms = new MenuScreen(this); // Creates a new MenuScreen object to start game with main menu.
