...
public class TurtleLevel extends BaseScreen // Extends the BaseScreen class.
{
    ...
    private Sound impactSound; // Sound to play when user touches a rock.
    private Sound starSound; // Sound to play when user touches a starfish.
    ...
    public final void create()
    {
        ...
        // Load sound to play when user touches a starfish.
        starSound = Gdx.audio.newSound(Gdx.files.internal("assets/audio/starfish_collect.wav"));
        
        // Load sound to play when user touches a rock.
        impactSound = Gdx.audio.newSound(Gdx.files.internal("assets/audio/impact.wav"));
