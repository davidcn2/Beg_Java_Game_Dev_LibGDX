...
public class CheeseMenu extends BaseScreen { // Extends the BaseScreen class.
    ...
    // create:  Configures and adds the Actors to the stage:  background, Cheese Please (title text), and 
    //          instructions.
    ...
    public CheeseMenu(Game g)
    {
        ...
        // Configure and add the actors to stage:  background, Cheese Please (title text), and instructions.
        create();
    }
    ...
    public final void create()
    {
        ...
        // 1.  Configures and adds the Actors:  background, Cheese Please (title text), and instructions.
        */
        ...
        titleText.setTexture( new Texture(Gdx.files.internal("assets/cheese-please.png")) ); // Load image to buffer.
