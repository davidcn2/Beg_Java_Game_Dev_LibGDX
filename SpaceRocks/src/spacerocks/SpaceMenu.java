...
public class SpaceMenu extends BaseScreen { // Extends the BaseScreen class.
    ...
    // g = Reference to the BaseGame object.
    SpaceMenu(BaseGame g)
    {
    ...
    public final void create()
    {
        ...
        1.  Loads, configures, and adds the space graphic to the Skin.
        2.  Sets the background in the uiTable to the space graphic.
        3.  Loads, configures, and adds the title graphic to the Skin.
        ...
        6.  Builds uiTable with title, start and quit buttons, and "created with libGDX".
        */
        ...
        Image titleImage; // Image object with title text.
        ...
        Texture titleTex; // Texture object with title text.
        Texture bgTex; // Texture object with background graphic.

        // Load background graphic into Texture object.
        bgTex = new Texture(Gdx.files.internal("assets/images/space.png"));

        // To ensure that image scales smoothly, specify linear filtering.
        bgTex.setFilter(TextureFilter.Linear, TextureFilter.Linear);

        // Add the Texture with the background graphic to the Skin.
        game.skin.add( "bgTex", bgTex );

        // Set background image for Table to related graphic.
        uiTable.background( game.skin.getDrawable("bgTex") );

        // Load title graphic into Texture object.
        titleTex = new Texture(Gdx.files.internal("assets/images/TitleText.png"));

        // To ensure that image scales smoothly, specify linear filtering.
        titleTex.setFilter(TextureFilter.Linear, TextureFilter.Linear);

        // Create new image object for title with associated Texture.
        ...
        quitButton.addListener(
...

                {
                    ...
                    public boolean touchDown (InputEvent event, float x, float y, int pointer, int button)
                    {
                        // Occurs when the user performs a mouse down (click) event on the quit button.
        ...
        // Add cell encompassing both columns containing the title image.
