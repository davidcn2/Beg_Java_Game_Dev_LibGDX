...
public class BaseActor extends Actor { // Extends the Actor class from LibGDX.
    ...
    private TextureRegion region; // Stores image (similar to a buffer from Direct-X).  Includes more
    ...
    private Rectangle boundary; // Encapsulates a 2D rectangle defined by its corner point in the
    ...
    private float velocityX; // Speed in pixels per second in the x direction.
    private float velocityY; // Speed in pixels per second in the y direction.
