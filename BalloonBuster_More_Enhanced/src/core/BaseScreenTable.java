...
public abstract class BaseScreenTable implements Screen, InputProcessor

{

    // The class uses the elements of the Screen and InputProcessor classes in LibGDX.
    ...
    */
    ...
    public Table uiTable; // Table containing main menu elements.
    public Table uiTable_Bottom; // Table containing elements displayed in bottom portion of screen.
    public Table uiTable_Center; // Table containing centered elements.
    ...
    // windowWidth = Width to set current window.
    // windowHeight = Height to set current window.
    // createTablesInd = Whether to create table objects.
    public BaseScreenTable(BaseGame g, int windowWidth, int windowHeight, boolean createTablesInd)
    {
        ...
        // 5.  Creates and attaches (root) Table to UI (main menu) stage.
        // 6.  (Conditionally) Creates child Table objects that will hold title and start button.
        ...
        // If creating Table objects, then...
        if (createTablesInd)
        {
            // Creating Table objects.
            uiTable = new Table(); // Create new Table object. > Root table.
            uiTable.setFillParent(true); // The method will set the size of the Table to that of the stage.
            uiTable_Bottom = new Table(); // Create new Table object that will hold the title.
            uiTable_Center = new Table(); // Create new Table object that will hold the start button.
