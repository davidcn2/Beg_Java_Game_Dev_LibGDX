...
public class BaseActor extends Actor // Extends the Actor class from LibGDX.
{
    ...
    // cloneActor:  Returns a BaseActor with the same properties as the class-level one.
    ...
    @SuppressWarnings("unused")
    public BaseActor cloneActor()
    {

        // The function returns a BaseActor with the same properties as the class-level one.
