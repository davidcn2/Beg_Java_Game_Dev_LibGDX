...

{
    ...
    */
    ...
    private Stage uiStage; // Stores a 2D scene graph containing UI actors.  Includes win text / labels.
    ...
    public BaseScreen(BaseGame g, int windowWidth, int WindowHeight)
    {
        ...
        /*
        Remove any previously added ControllerListener objects to prevent inactive Screen objects (still residing in memory)
        from responding to input, because of the potential for unexpected problems.
        */
        Controllers.clearListeners();

        // "Activate" the listener.  Add the currently active Screen to the set of listeners managed by the Controllers class.
