 ...
 * @author dcohn
 */
public class CheesePlease5 extends Game { // Extends the Game class from LibGDX.
    ...
    // when winning.
    private Label timeLabel; // LibGDX Label object that will display elapsed time.  Note:  A Label is an extension of an Actor.
    ...
    public CheesePlease5() 
    {
        
        // The constructor of the class initializes the constants.
    ...
    public void create()
    {
        ...
        // The function creates the 2D scene graphs and adds the Actors:  floor, cheese, mouse, and
        // win and time messages.
    ...
    public void render()
    {
        ...
        3.  Stores the time span between the current and the last frame.
        4.  Adjusts Actor positions and other properties.
        5.  Restricts mouse to window boundaries.
        6.  Updates elapsed time and related message.
        6.  Checks for a win and adjusts accordingly.
        ...
        */
        ...
        // Calls the Actor.act(float) method on each actor in the stages.
