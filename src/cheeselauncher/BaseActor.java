...
public class BaseActor extends Actor { // Extends the Actor class from LibGDX.
    ...
    // The class extends the basic functionality of an Actor object in LibGDX.
    ...
    // functionality that a Texture.  Supports storage of multiple images or animation frames.
    ...
    public BaseActor()
    {
        ...
        // creates texture region and 2D rectangle objects, and sets the x and y
        // velocities to 0 pixels per second.
    ...
    public void act(float dt)
    {
        ...
        // Move the Actor based on the distance traveled.
