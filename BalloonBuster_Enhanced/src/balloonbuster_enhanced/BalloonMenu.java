...
public class BalloonMenu extends BaseScreen { // Extends the BaseScreen class.
    ...
    // create:  Configures and adds the Actors to the stage:  background, title text, and instructions.
    ...
    public BalloonMenu(Game g)
    {
        ...
        // Configure and add the actors to stage:  background, title text, and instructions.
        create();
    }
    ...
    public final void create()
    {
        ...
        // 1.  Configures and adds the Actors:  background, title text, and instructions.
        */
        ...
        Label instructions; // LibGDX Label object that will display instructions.
        Label titleText; // LibGDX Label object that will display title text.
        ...
        background.setTexture( new Texture(Gdx.files.internal("assets/tiles-menu.jpg")) ); // Load image to buffer.
        ...
        instructions = new Label( textInstructions, style ); // Add text and style to Label.
        instructions.setFontScale(2); // Make font appear larger by using setFontScale method.
        centerLabelUI(uiStage, instructions); // Center main menu instructions.
        ...
        // Set up Label object that will display main menu title text.
        // Note:  Best practices include avoiding scaling -- use a high-resolution image, instead.
        titleText = new Label( textTitle, style ); // Add text and style to Label.
        titleText.setFontScale(2); // Make font appear larger by using setFontScale method.
        titleText.setPosition(20, 100); // Set coordinates of the Label.
        
        uiStage.addActor( titleText ); // Add main menu title Label to the scene graph.
