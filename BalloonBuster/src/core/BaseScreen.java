...

{
    ...
    */
    ...
    // Includes:  Floor, cheese, mousey.
    protected Stage uiStage; // Stores a 2D scene graph containing the UI actors.
    // Includes win text and time label.
    
    public final int viewWidth; // Window width.
    public final int viewHeight; // Window height.
    ...
    public BaseScreen(Game g)
    {
        ...
        // stage gets added to the input multiplexer.  When input events occur, the input
        // multiplexer forwards the information to each of the attached objects.
