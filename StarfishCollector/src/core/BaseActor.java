...
public class BaseActor extends Actor // Extends the Actor class.
{
    ...
    // copy:  Copies properties from the passed to the current Actor.
    ...
    public Polygon boundingPolygon; // Encapsulates a 2D polygon definited by its vertices.
    ...
    public BaseActor()
    {
        ...
        // creates texture region and polygon objects, and initializes the color engine.
    ...
    public void copy(BaseActor original)
    {
        ...
        // The function copies properties from the passed to the current Actor.
        // Properties include:  image texture (buffer), bounding polygon, position, origin, width,
        // height, tint color, and visiblity status.
