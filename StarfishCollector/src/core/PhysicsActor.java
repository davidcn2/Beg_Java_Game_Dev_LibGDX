...
public class PhysicsActor extends AnimatedActor { // Extends the AnimatedActor class.
    ...
    */
    ...
    // addAccelerationXY:  Adds the passed x and y value to the acceleration vector.
    // addVelocityXY:  Adds the passed x and y value to the velocity vector.
    ...
    {
        // Add the passed x and y value to the velocity vector.
        velocity.add(vx,vy);
    }
    ...
    {
        // Add the passed x and y value to the acceleration vector.
